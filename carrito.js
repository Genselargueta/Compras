...
$(document).ready(function () {
    ...
    $('#compras').click(function () {
        ...
        carritoHTML += '</ul><button id="comprarProductos" style="background: green; color: white; border: none; padding: 10px 20px; cursor: pointer;">Comprar</button>';
        ...
        modal.html(`${carritoHTML}<button id="cerrarCarrito" style="margin-top: 10px; background: gray; color: white; border: none; padding: 5px 10px; cursor: pointer;">Cerrar</button>`);
        $('body').append(modal);
